...
const HeroSection: React.FC = () => {
  return (
    <section
      className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56 text-center bg-cover bg-center relative"
      style={{ backgroundImage: "url('/images/your-image.jpg')" }} // Ensure this path is correct
    >
      <div className="bg-gradient-to-t  to-transparent absolute inset-0"></div>
