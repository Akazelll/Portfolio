...
import { useMediaQuery } from "@/app/hooks/useMediaQuery"; // pastikan path sesuai
...
const ProjectPage = ({ projects }: { projects: Project[] }) => {
  const isMobile = useMediaQuery("(max-width: 768px)"); // ⬅️ detect mobile
        ...
        >
          {projects.map((project) => (
            <motion.div
              ...
              {...(!isMobile && { exit: "exit" })} // ⬅️ animasi exit hanya desktop
            >
